...
- [ ] **Instrumentals library & project beat management** — importing a selected beat directly into its project is complete; a browsable global instrumentals library (e.g. `Music/Gh0stwrit3r/Instrumentals/` or another user-accessible directory) remains to be built. Assigned beats are copied into the project directory so projects stay self-contained.
