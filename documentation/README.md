...
- **[AGENT_CONTEXT.md](AGENT_CONTEXT.md)**  
  ...
  - Architecture breakdown of all current screens (`HomeScreen`, `EditorScreen`, `SettingsScreen`, `AboutScreen`) and data handlers (`Settings`, `ProjectStorage`).
...
- **[TESTING.md](TESTING.md)**
  Test commands, Android Studio workflow, and local, instrumented, and unified
